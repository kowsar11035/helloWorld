...
namespace AccountsManagementSystem.UI
{
    public partial class LedgerEntryUpdate : Form
    {
        ...
        private void Reset()
        {
            txtEntryId.Text = "";
            txtLedgerName.Text = "";
            txtTransactiondate.MinDate = MainUI.startDateM;
            txtTransactiondate.MaxDate = MainUI.endDateM;
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            //debit = Convert.ToDecimal(txtReceive.Text);
            //credit = Convert.ToDecimal(txtExpence.Text);
            ...
            try
            {
               ...
               // cmd.Parameters.AddWithValue("@d1", ledgerId);
                ...
                //cmd.Parameters.AddWithValue("@d4",Convert.ToDateTime(txtTransactiondate.Value,System.Globalization.CultureInfo.GetCultureInfo("hi-IN").DateTimeFormat));
                cmd.Parameters.AddWithValue("@d4", txtParticulars.Text);

               // cmd.Parameters.AddWithValue("@d5", (object)debit ?? DBNull.Value);

               // cmd.Parameters.AddWithValue("@d6", (object)credit ?? DBNull.Value);
              //  cmd.Parameters.AddWithValue("@d7", fiscalULE4Year);
        ...
        {
            fiscalULE4Year = MainUI.fiscalMYear;
            txtEntryId.Focus();
